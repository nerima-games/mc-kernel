/* eslint-disable max-statements, no-magic-numbers -- Enchantment table randomness and costs are the contract under test. */
...
describe('enchantment table data', () => {
  ...
  it('stores enchantability for supported table inputs', () => {
    expect(ENCHANTMENT_TABLE_ITEM_ENMERCHANTABILITY.iron_sword).toBe(14)
...
describe('enchantment table level calculation', () => {
  ...
  it('rejects invalid levels, bookshelf counts, slots, and random integers', () => {
    ...
    expect(() =>
      Reflect.apply(calculateEnchantmentTableLevelCost, undefined, [{
          item: ENCHANTMENT_TABLE_BOOK,
          bookshelfCount: 0,
          random: zeroRandom(),
          slot: 3,
