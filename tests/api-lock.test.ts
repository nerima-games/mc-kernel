 ...
 *
 * The current public surface is checked by `pnpm api:check`, which runs in
 * `pnpm verify` and CI. These tests instead validate the reusable renderer.
 *
