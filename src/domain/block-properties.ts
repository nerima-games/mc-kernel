 ...
 * instead of being a boolean. `historical design audit` is the
 ...
 * ---------------------------------------------------------------------------
 *
 * Audit §5 found that three of the capabilities the design contract spelled as
 ...
 *       `TRANSPARENT_SOLID_IDS_ARRAY` (GLASS/LEAVES, atlas + alpha). the design contract
 ...
 *
 * Ordered here as the design contract orders the render priority:
