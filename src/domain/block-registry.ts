...
import type { ResolvedBlock } from './block-definition'
import { resolveBlock } from './block-definition'
import type { BlockDrop, HarvestContext } from './block-harvest'
import { BARE_HANDED, resolveDrop } from './block-harvest'
...
import { isSupportSensitive, satisfiesSupportRule } from './block-support'
import type { BlockType } from './block-type'
import { BLOCK_TYPES } from './block-type'
import { BLOCK_REGISTRY } from './block-registry-data'
import { AIR_BLOCK_ID, BlockId } from './block-registry-types'

export { BLOCK_REGISTRY } from './block-registry-data'
export { AIR_BLOCK_ID, BLOCK_ID_MAX, BlockId } from './block-registry-types'
export type { BlockRegistryEntry } from './block-registry-types'
