...
export const ITEM_TYPES = [
  ...
  //                                     Carries
  //
  // `crafting_table` is kept with the itemised block forms below because its
  // block and inventory identities are the same canonical item.
  "coal",
  "iron_ingot",
  "flint",
  "gunpowder",
  ...
  // Fixed-stat food components and their use remainders. Dynamic food
  // components remain above this data-only registry until their component
  // payload has a stable kernel representation.
  "apple",
  "baked_potato",
  "beef",
  "beetroot",
  ...
  // Java special-recipe vocabulary. Appended to preserve every existing item
  // id while keeping recipe inputs and transmuted outputs inside ItemType.
  "written_book",
  "writable_book",
  "filled_map",
  "firework_star",
