...
export * from './enchantment-data.js'
...
type SupportedEnchantmentId = SupportedVanillaEnchantmentId | AnvilEnchantmentId
...
export const enchantmentRuleFor = (value: SupportedEnchantmentId): AnvilEnchantmentRule | undefined =>
  RULES_BY_ID.get(AnvilEnchantmentId(value))

export const enchantmentAppliesTo = (enchantment: SupportedEnchantmentId, item: ItemType): boolean =>
  enchantmentRuleFor(enchantment)?.applicableItems.includes(item) ?? false

export const enchantmentsConflict = (left: SupportedEnchantmentId, right: SupportedEnchantmentId): boolean => {
